...
GitHub's private reporting: **[Report a vulnerability](https://github.com/RizRiyz/luvus/security/advisories/new)**
...
luvus is a **single-user, local-trust** tool:

- Its control sockets live in `~/.luvus/` (created `0700`, sockets `0600`) and
...
- Remote attach rides plain `ssh` — luvus adds no network listener of its own.
