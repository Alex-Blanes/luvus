...
fn resolve_go_to_path(
        ...
        .or_else(|| entered.strip_prefix("~\\"))
    {
        ...
        // `user_path` turns a bare drive letter (`D:`, the way a drive change is
        // typed) into that drive's root; the path API alone reads it as
        // drive-relative and it would never leave `C:`. No-op off Windows.
