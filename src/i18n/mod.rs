...
pub struct Catalog {
    ...
    pub scope_workspace: &'static str,
    pub all: &'static str,
    ...
    pub set_auto_update: &'static str,
    /// Changelog row: restart onto the installed binary, session preserved.
    pub restart_now: &'static str,
    /// Toast: agents are still working; the ask has to be repeated.
    pub restart_busy: &'static str,
    pub restart_after_install: &'static str,
    /// Toast: a newer fork build was installed and only needs a restart.
    pub update_installed: &'static str,
    /// Changelog note: upstream released something this fork has not merged.
    pub upstream_available: &'static str,
...
pub static EN: Catalog = Catalog {
    ...
    update_hint: "Update luvus with:",
    set_check_updates: "Check for updates",
    set_auto_update: "Install updates automatically",
    restart_now: "Restart to load the installed version",
    restart_busy: "Agents still working, press again to restart anyway:",
    restart_after_install: "Update still installing — restarting as soon as it lands",
    update_installed: "Update installed, restart to load",
    upstream_available: "Upstream release not merged yet:",
    ...
    cmd_toggle_agents: "Agents: space / all / active",
...
static ES: Catalog = Catalog {
    ...
    update_hint: "Actualiza luvus con:",
    set_check_updates: "Buscar actualizaciones",
    set_auto_update: "Instalar actualizaciones automáticamente",
    restart_now: "Reiniciar para cargar la versión instalada",
    restart_busy: "Hay agentes trabajando, pulsa otra vez para reiniciar igualmente:",
    restart_after_install: "La actualización sigue instalándose — reiniciará en cuanto termine",
    update_installed: "Actualización instalada, reinicia para cargarla",
    upstream_available: "Versión de upstream sin integrar:",
    ...
    cmd_toggle_agents: "Agentes: espacio / todos / activos",
...
static PT: Catalog = Catalog {
    ...
    update_hint: "Atualize o luvus com:",
    set_check_updates: "Verificar atualizações",
    set_auto_update: "Instalar atualizações automaticamente",
    restart_now: "Reiniciar para carregar a versão instalada",
    restart_busy: "Agentes ainda trabalhando, pressione de novo para reiniciar mesmo assim:",
    restart_after_install:
        "A atualização ainda está sendo instalada — reiniciará assim que terminar",
    update_installed: "Atualização instalada, reinicie para carregar",
    upstream_available: "Versão do upstream ainda não integrada:",
    ...
    cmd_toggle_agents: "Agentes: espaço / todos / ativos",
...
static FR: Catalog = Catalog {
    ...
    update_hint: "Mettez luvus à jour avec :",
    set_check_updates: "Rechercher des mises à jour",
    set_auto_update: "Installer les mises à jour automatiquement",
    restart_now: "Redémarrer pour charger la version installée",
    restart_busy: "Des agents travaillent encore, appuyez à nouveau pour redémarrer quand même :",
    restart_after_install: "Mise à jour en cours d'installation — redémarrage dès qu'elle arrive",
    update_installed: "Mise à jour installée, redémarrez pour la charger",
    upstream_available: "Version amont non fusionnée :",
    ...
    cmd_toggle_agents: "Agents : espace / tous / actifs",
    ...
    menu_move_to_tab: "Déplacer vers",
...
static DE: Catalog = Catalog {
    ...
    update_hint: "Luvus aktualisieren mit:",
    set_check_updates: "Nach Updates suchen",
    set_auto_update: "Updates automatisch installieren",
    restart_now: "Neu starten, um die installierte Version zu laden",
    restart_busy: "Agenten arbeiten noch, erneut drücken zum Neustart:",
    restart_after_install: "Update wird noch installiert — Neustart, sobald es fertig ist",
    update_installed: "Update installiert, zum Laden neu starten",
    upstream_available: "Upstream-Release noch nicht übernommen:",
    ...
    cmd_toggle_agents: "Agenten: Bereich / alle / aktiv",
    ...
    menu_move_to_tab: "Verschieben nach",
...
static ID: Catalog = Catalog {
    ...
    update_hint: "Perbarui luvus dengan:",
    set_check_updates: "Periksa pembaruan",
    set_auto_update: "Pasang pembaruan otomatis",
    restart_now: "Mulai ulang untuk memuat versi terpasang",
    restart_busy: "Agen masih bekerja, tekan lagi untuk tetap mulai ulang:",
    restart_after_install: "Pembaruan masih dipasang — akan mulai ulang begitu selesai",
    update_installed: "Pembaruan dipasang, mulai ulang untuk memuat",
    upstream_available: "Rilis upstream belum digabungkan:",
    ...
    cmd_toggle_agents: "Agen: ruang / semua / aktif",
...
static ZH: Catalog = Catalog {
    ...
    update_hint: "使用以下命令更新 luvus：",
    set_check_updates: "检查更新",
    set_auto_update: "自动安装更新",
    restart_now: "重启以加载已安装的版本",
    restart_busy: "仍有代理在工作，再按一次以强制重启：",
    restart_after_install: "更新仍在安装 — 完成后立即重启",
    update_installed: "更新已安装，重启后生效",
    upstream_available: "尚未合并的上游版本：",
    ...
    cmd_toggle_agents: "代理：工作区 / 全部 / 活动",
...
static JA: Catalog = Catalog {
    ...
    update_hint: "次のコマンドで luvus を更新:",
    set_check_updates: "アップデートを確認",
    set_auto_update: "アップデートを自動インストール",
    restart_now: "再起動してインストール済みの版を読み込む",
    restart_busy: "稼働中のエージェントがあります。もう一度押すと再起動:",
    restart_after_install: "更新をインストール中 — 完了次第再起動します",
    update_installed: "アップデート済み、再起動で反映",
    upstream_available: "未統合の upstream リリース:",
    ...
    cmd_toggle_agents: "エージェント: 作業空間 / 全部 / アクティブ",
...
static KO: Catalog = Catalog {
    ...
    // Fork-only strings (the AGENTS workspace scope, the drive list, and the
    // update/restart flow). Korean joined upstream after them, so they are
    // translated here rather than carried over.
    scope_workspace: "작업 공간",
    drives: "드라이브",
    set_auto_update: "업데이트 자동 설치",
    restart_now: "설치된 버전을 불러오려면 다시 시작",
    restart_busy: "에이전트가 아직 작업 중입니다. 그래도 다시 시작하려면 한 번 더 누르세요:",
    restart_after_install: "업데이트 설치 중 — 끝나는 대로 다시 시작합니다",
    update_installed: "업데이트 설치됨, 다시 시작하여 불러오기",
    upstream_available: "아직 병합되지 않은 업스트림 릴리스:",
    workspaces: "작업 공간",
    agents: "에이전트",
    files: "파일",
    switch_to: "전환",
