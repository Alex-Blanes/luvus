...
#   LUVUS_BIN_PATH        the running luvus binary (use it, not `luvus` on PATH)
#   LUVUS_WORKSPACE_CWD   the folder of the node this was invoked against
#   LUVUS_SETTING_LIMIT   the "Branches to show" setting
#   LUVUS_SETTING_SORT    the "Sort by" setting
set -eu
